...
export function RoleEditor({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className="fixed top-0 right-0 bottom-0 left-0 z-50 flex min-h-screen items-center justify-center bg-black/40">
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    >
                      {documents
                        .filter((doc) => doc.id)
                        .every((doc) =>
                          formData.documentAccess.includes(doc.id!)
                        )
                        ? "Deselect All"
                        : "Select All"}
                    </Button>
                        ...
                        document.id && (
                          ...
                          >
                            <Checkbox
                              ...
                              checked={formData.documentAccess.includes(
                                document.id
                              )}
                              onCheckedChange={(checked) =>
                                document.id &&
                                handleDocumentAccessChange(
                                  document.id,
                                  checked as boolean
                                )
                              }
